    ...
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-4 py-20 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10 flex flex-col items-center gap-10">
        ...
        <div className="text-center">
          <motion.h1 
            className="hero-heading relative text-4xl md:text-6xl font-extrabold mb-6 leading-tight"
          ...
          <motion.p 
            className="text-lg md:text-xl font-light text-white/80 mb-10 leading-relaxed max-w-3xl mx-auto"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
